      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://raw.githubusercontent.com/ronething/yijiaren/backup/min_photos/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/ronething/yijiaren/backup/photos/' + data.link[i];
